<template>
  <div class="payslip">
    ...
    <div class="employee-details">
      <p><strong>Name:</strong> <span style="display: inline-block; width: 75px"></span> {{ completeName }}</p>
      <p><strong>Position:</strong> <span style="display: inline-block; width: 65px"></span> Instructor I</p>
      <p><strong>Employee ID #:</strong> <span style="display: inline-block; width: 30px"></span> MCC - {{ employeeNumber }}</p>
    </div>
    ...
    <div class="earnings">
      <p><strong>Gross Amount Earned:</strong> <span style="display: inline-block; width: 150px"></span> 29,165.00</p>
    </div>

    <div class="deductions">
      <p><strong>DEDUCTIONS</strong></p>
      <p><strong>Mandatory (Contributions)</strong></p>
      <p><span style="display: inline-block; width: 25px"></span>* SSS<span style="display: inline-block; width: 65px"></span>{{ sss }}</p>
      <p><span style="display: inline-block; width: 25px"></span>HDMF<span style="display: inline-block; width: 64px"></span>1</p>
      <p><span style="display: inline-block; width: 25px"></span><strong>* PhilHealth:</strong><span style="display: inline-block; width: 25px"></span>{{ philHealth }}</p>
      <p>Withholding Tax</p>
      ...
      <div class="loan-details">
        <p><span style="display: inline-block; width: 25px"></span>Conso. Loan</p>
        <p><span style="display: inline-block; width: 25px"></span>P.L.R/PLO</p>
        ...
        <p><span style="display: inline-block; width: 25px"></span>EI/educ'l Assistance</p>
      </div>
      <p><strong>LWOP:</strong> <span style="display: inline-block; width: 85px"></span> {{ lwop }}</p>
      <p><strong>Total Deductions:</strong> <span style="display: inline-block; width: 170px"></span>{{ totalDeductions }}</p>
    </div>

    <div class="net-pay">
      <p><strong>NET PAY:</strong> <span style="display: inline-block; width: 220px"></span> 26,334.12</p>
    </div>

    <br />
    <div class="approval">
      <table>
        <tr><td><p><strong>Certified Correct:</strong></p></td></tr>
        <tr><td><p>ANNABELLE Q. MADRIGAL</p><p>AO V</p></td></tr>
      </table>
