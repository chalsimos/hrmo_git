<template>
    <div class="payslip">
      <div class="header">
        <img src="msu_logo.png" alt="Mindoro State University" class="logo" />
      ...
      <h2>Payslip</h2>
      <h6>September 11, 2024 to October 10, 2024</h6>
      <div class="employee-details">
        <p>
          <strong>Name:</strong>
          <span style="display: inline-block; width: 75px"></span> JOHN JARED S.
          MAGDAEL
        </p>
        <p>
        ...
        <p>
          ...
          ><span style="display: inline-block; width: 30px"></span> MCC - 507
        </p>
      </div>
      ...
      <div class="deductions">
        ...
        <p>
          ...
          <span style="display: inline-block; width: 25px"></span>1,458.25
        </p>
        <p>Withholding Tax</p>
        ...
        <p>
          <strong>LWOP:</strong
          ><span style="display: inline-block; width: 85px"></span> 1,372.63
        </p>
        <p>
          <strong>Total Deductions:</strong>
          <span style="display: inline-block; width: 170px"></span>2,830.88
        </p>
      </div>
